...
class Standar_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id_standar,nama_standar');
        $this->datatables->from('standar');
        //add this line for join
        //$this->datatables->join('table2', 'standar.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('standar/read/$1'),'Read')." | ".anchor(site_url('standar/update/$1'),'Update')." | ".anchor(site_url('standar/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_standar');
