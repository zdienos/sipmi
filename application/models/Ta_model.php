...
class Ta_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id_ta,nama_ta');
        $this->datatables->from('ta');
        //add this line for join
        //$this->datatables->join('table2', 'ta.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('ta/read/$1'),'Read')." | ".anchor(site_url('ta/update/$1'),'Update')." | ".anchor(site_url('ta/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_ta');
