...
class Ta_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id_ta,nama_ta,awal,akhir,status');
        $this->datatables->from('ta');
        //add this line for join
        //$this->datatables->join('table2', 'ta.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('ta/read/$1'),'<i class="fa fa-info"></i>','class="btn btn-success"')." ".anchor(site_url('ta/update/$1'),'<i class="fa fa-pencil"></i>','class="btn btn-warning"')." ".anchor(site_url('ta/delete/$1'),'<i class="fa fa-trash"></i>','class="btn btn-danger"'.' onclick="javasciprt: return confirm(\'Apakah anda yakin akan menghapus data ini??\')"'), 'id_ta');
