...
class Indikator_ta_model extends CI_Model
{
  ...
  // datatables
  function json() {
    $this->datatables->select('id_indikator_ta,nama_ta,indikator.nama as nama_indikator,tgl_isi,tgl_update,file,(nilai*bobot) as nilai,indikator_ta.status as status,isian,concat(user.username," : " ,level.nama_level) as username, concat(ta.status,",",indikator_ta.id_indikator_ta,",",indikator_ta.status) as status_ta,concat(status_aksi,",",indikator_ta.id_indikator_ta) as status_aksi');
